...
* Read the files from different folders based on author name from the folder name
...
* Created a document term matrix that comprises columns with all terms written in the documents and each row being by document
...
* Predict accuracy of author attribution on test set with approx. 33% accuracy
